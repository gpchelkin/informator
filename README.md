...
Реализовать как отдельно взятый из сети / локально файл-RSS-источник в своей вкладке с выбором отображения / неотображения (наподобие таблицы фидов) сообщений? А источник уже будет защищенно в другом месте редактироваться ручками, как и feeds.txt.
